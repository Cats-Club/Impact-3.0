...
import me.zero.clarinet.event.api.events.EventStoppable;
...
public final class EventManager {
	...
	/**
	 * Determines the state of the Event Manager
	 */
	...
	/**
	 * Shuts down the Event Manager, preventing any further Event calls
	 */
	...
	/**
	 * Returns size of registry map
	 */
	public static int getRegisteredEventCount() {
		int amt = 0;
		for (List<MethodData> md : REGISTRY_MAP.values()) {
			amt += md.size();
		}
		return amt;
	}
