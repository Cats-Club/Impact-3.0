...
import me.zero.clarinet.mod.misc.ScreenshotUploader;
...
public class ScreenShotHelper
{
    ...
    public static ITextComponent saveScreenshot(File gameDirectory, String screenshotName, int width, int height, Framebuffer buffer)
    {
        try
        {
            ...
            if(Impact.getInstance().getModManager().get(ScreenshotUploader.class).isToggled()){
                MiscUtils.uploadToImgur(file2);
            }
