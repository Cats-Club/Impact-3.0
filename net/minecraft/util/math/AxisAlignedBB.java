...
public class AxisAlignedBB
{
    ...
    public AxisAlignedBB(net.minecraft.util.math.BlockPos pos)
    {
        this((double)pos.getX(), (double)pos.getY(), (double)pos.getZ(), (double)(pos.getX() + 1), (double)(pos.getY() + 1), (double)(pos.getZ() + 1));
    }

    public AxisAlignedBB(net.minecraft.util.math.BlockPos pos1, net.minecraft.util.math.BlockPos pos2)
    {
        this((double)pos1.getX(), (double)pos1.getY(), (double)pos1.getZ(), (double)pos2.getX(), (double)pos2.getY(), (double)pos2.getZ());
    }

    public AxisAlignedBB(net.minecraft.util.math.Vec3d p_i47144_1_, net.minecraft.util.math.Vec3d p_i47144_2_)
    {
    ...
    public boolean func_189973_a(net.minecraft.util.math.Vec3d p_189973_1_, net.minecraft.util.math.Vec3d p_189973_2_)
    {
    ...
    {
        net.minecraft.util.math.Vec3d vec3d = this.collideWithXPlane(this.minX, vecA, vecB);
        EnumFacing enumfacing = EnumFacing.WEST;
        net.minecraft.util.math.Vec3d vec3d1 = this.collideWithXPlane(this.maxX, vecA, vecB);
    ...
    @VisibleForTesting
    boolean isClosest(net.minecraft.util.math.Vec3d p_186661_1_, @Nullable net.minecraft.util.math.Vec3d p_186661_2_, net.minecraft.util.math.Vec3d p_186661_3_)
    {
    ...
    @Nullable
    @VisibleForTesting
    net.minecraft.util.math.Vec3d collideWithXPlane(double p_186671_1_, net.minecraft.util.math.Vec3d p_186671_3_, net.minecraft.util.math.Vec3d p_186671_4_)
    {
        net.minecraft.util.math.Vec3d vec3d = p_186671_3_.getIntermediateWithXValue(p_186671_4_, p_186671_1_);
        return vec3d != null && this.intersectsWithYZ(vec3d) ? vec3d : null;
    }

    @Nullable
    @VisibleForTesting
    net.minecraft.util.math.Vec3d collideWithYPlane(double p_186663_1_, net.minecraft.util.math.Vec3d p_186663_3_, net.minecraft.util.math.Vec3d p_186663_4_)
    {
        net.minecraft.util.math.Vec3d vec3d = p_186663_3_.getIntermediateWithYValue(p_186663_4_, p_186663_1_);
        return vec3d != null && this.intersectsWithXZ(vec3d) ? vec3d : null;
    }

    @Nullable
    @VisibleForTesting
    net.minecraft.util.math.Vec3d collideWithZPlane(double p_186665_1_, net.minecraft.util.math.Vec3d p_186665_3_, net.minecraft.util.math.Vec3d p_186665_4_)
    {
        net.minecraft.util.math.Vec3d vec3d = p_186665_3_.getIntermediateWithZValue(p_186665_4_, p_186665_1_);
        return vec3d != null && this.intersectsWithXY(vec3d) ? vec3d : null;
    }

    @VisibleForTesting
    public boolean intersectsWithYZ(net.minecraft.util.math.Vec3d vec)
    {
        return vec.yCoord >= this.minY && vec.yCoord <= this.maxY && vec.zCoord >= this.minZ && vec.zCoord <= this.maxZ;
    }

    @VisibleForTesting
    public boolean intersectsWithXZ(net.minecraft.util.math.Vec3d vec)
    {
        return vec.xCoord >= this.minX && vec.xCoord <= this.maxX && vec.zCoord >= this.minZ && vec.zCoord <= this.maxZ;
    }

    @VisibleForTesting
    public boolean intersectsWithXY(net.minecraft.util.math.Vec3d vec)
    {
    ...
    public net.minecraft.util.math.Vec3d func_189972_c()
    {
