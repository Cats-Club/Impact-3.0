...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            // TODON'T: Impact
            boolean flag2 = this.onGround && Impact.getInstance().getModManager().get(SafeWalk.class).isToggled() && this instanceof EntityPlayerSP;
            ...
            {
                // TODON'T: Impact
                EventStep event = new EventStep(this, this.stepHeight, EventType.PRE);
                ...
                // TODON'T: Impact
                y = event.stepHeight; //(double)this.stepHeight
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z)
                {
                    ...
                    // TODON'T: Impact
                    EventManager.call(new EventStep(this, this.stepHeight, EventType.POST));
                }
            }
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound compound)
    {
        try
        {
            ...
            {
                compound.setBoolean("NoGravity", this.func_189652_ae());
            }
    ...
    public float getCollisionBorderSize()
    {
        ...
        if (hitbox.isToggled()) {
            return hitbox.amount.getValue().floatValue();
        }
