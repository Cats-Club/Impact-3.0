...
public abstract class EntityHanging extends net.minecraft.entity.Entity
{
    private static final Predicate<net.minecraft.entity.Entity> IS_HANGING_ENTITY = new Predicate<net.minecraft.entity.Entity>()
    {
        public boolean apply(@Nullable net.minecraft.entity.Entity p_apply_1_)
        {
    ...
    public void onUpdate()
    {
        ...
        if (this.tickCounter1++ == 100 && !this.worldObj.isRemote)
        {
            ...
            {
                this.setDead();
                this.onBroken((net.minecraft.entity.Entity)null);
            }
        }
    }
     ...
     */
    public boolean hitByEntity(net.minecraft.entity.Entity entityIn)
    {
