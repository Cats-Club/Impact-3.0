...
public class PhaseSittingFlaming extends PhaseSittingBase
{
    ...
    public void doLocalUpdate()
    {
        ...
        if (this.flameTicks >= 200)
        {
            ...
            {
                this.dragon.getPhaseManager().setPhase(net.minecraft.entity.boss.dragon.phase.PhaseList.TAKEOFF);
            }
            else
            {
                this.dragon.getPhaseManager().setPhase(net.minecraft.entity.boss.dragon.phase.PhaseList.SITTING_SCANNING);
            }
        }
    ...
    public net.minecraft.entity.boss.dragon.phase.PhaseList<PhaseSittingFlaming> getPhaseList()
    {
