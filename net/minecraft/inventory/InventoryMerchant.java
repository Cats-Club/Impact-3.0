...
public class InventoryMerchant implements IInventory
{
    ...
    public ItemStack decrStackSize(int index, int count)
    {
        ...
        {
            return net.minecraft.inventory.ItemStackHelper.getAndSplit(this.theInventory, index, this.theInventory[index].stackSize);
        }
        else
        {
            ItemStack itemstack = net.minecraft.inventory.ItemStackHelper.getAndSplit(this.theInventory, index, count);
