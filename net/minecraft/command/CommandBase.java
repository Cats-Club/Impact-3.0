...
public abstract class CommandBase implements net.minecraft.command.ICommand
{
    ...
    public static void notifyCommandListener(ICommandSender sender, net.minecraft.command.ICommand command, String translationKey, Object... translationArgs)
    {
        notifyCommandListener(sender, command, 0, translationKey, translationArgs);
    }

    public static void notifyCommandListener(ICommandSender sender, net.minecraft.command.ICommand command, int flags, String translationKey, Object... translationArgs)
    {
