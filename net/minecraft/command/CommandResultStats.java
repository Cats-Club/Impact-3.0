...
public class CommandResultStats
{
    ...
    public void setCommandStatForSender(MinecraftServer server, final net.minecraft.command.ICommandSender sender, Type typeIn, int p_184932_4_)
    {
        String s = this.entitiesID[typeIn.getTypeID()];

        if (s != null)
        {
            net.minecraft.command.ICommandSender icommandsender = new ICommandSender()
            {
