...
public class NBTTagList extends net.minecraft.nbt.NBTBase
{
    private static final Logger LOGGER = LogManager.getLogger();
    private List<net.minecraft.nbt.NBTBase> tagList = Lists.<net.minecraft.nbt.NBTBase>newArrayList();
    ...
    void write(DataOutput output) throws IOException
    {
        ...
        {
            this.tagType = ((net.minecraft.nbt.NBTBase)this.tagList.get(0)).getId();
        }
        ...
        {
            ((net.minecraft.nbt.NBTBase)this.tagList.get(i)).write(output);
        }
    }
    ...
    void read(DataInput input, int depth, NBTSizeTracker sizeTracker) throws IOException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                this.tagList = Lists.<net.minecraft.nbt.NBTBase>newArrayListWithCapacity(i);

                for (int j = 0; j < i; ++j)
                {
                    net.minecraft.nbt.NBTBase nbtbase = net.minecraft.nbt.NBTBase.createNewByType(this.tagType);
     ...
     * previous tag.
     */
    public void appendTag(net.minecraft.nbt.NBTBase nbt)
    {
        if (nbt.getId() == 0)
        {
     ...
     */
    public void set(int idx, net.minecraft.nbt.NBTBase nbt)
    {
        if (nbt.getId() == 0)
        {
            LOGGER.warn("Invalid TagEnd added to ListTag");
     ...
     */
    public net.minecraft.nbt.NBTBase removeTag(int i)
    {
        return (net.minecraft.nbt.NBTBase)this.tagList.remove(i);
    }
    ...
    public NBTTagCompound getCompoundTagAt(int i)
    {
        ...
        {
            net.minecraft.nbt.NBTBase nbtbase = (net.minecraft.nbt.NBTBase)this.tagList.get(i);
    ...
    public int getIntAt(int p_186858_1_)
    {
        ...
        {
            net.minecraft.nbt.NBTBase nbtbase = (net.minecraft.nbt.NBTBase)this.tagList.get(p_186858_1_);
     ...
     */
    public net.minecraft.nbt.NBTBase get(int idx)
    {
        return (net.minecraft.nbt.NBTBase)(idx >= 0 && idx < this.tagList.size() ? (net.minecraft.nbt.NBTBase)this.tagList.get(idx) : new NBTTagEnd());
    }
    ...
    public NBTTagList copy()
    {
        ...
        for (net.minecraft.nbt.NBTBase nbtbase : this.tagList)
        {
