...
public class ScorePlayerTeam extends net.minecraft.scoreboard.Team
{
    private final net.minecraft.scoreboard.Scoreboard theScoreboard;
     ...
     */
    public static String formatPlayerName(@Nullable net.minecraft.scoreboard.Team teamIn, String string)
    {
