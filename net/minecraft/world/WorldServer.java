...
public class WorldServer extends net.minecraft.world.World implements IThreadListener
{
     ...
     */
    private final net.minecraft.world.Teleporter worldTeleporter;
    ...
    public WorldServer(MinecraftServer server, ISaveHandler saveHandlerIn, WorldInfo info, int dimensionId, Profiler profilerIn)
    {
        ...
        this.worldTeleporter = new net.minecraft.world.Teleporter(this);
     ...
     */
    public net.minecraft.world.Explosion newExplosion(@Nullable Entity entityIn, double x, double y, double z, float strength, boolean isFlaming, boolean isSmoking)
    {
        net.minecraft.world.Explosion explosion = new Explosion(this, entityIn, x, y, z, strength, isFlaming, isSmoking);
