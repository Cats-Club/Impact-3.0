...
public class LootTable
{
    ...
    public static final LootTable EMPTY_LOOT_TABLE = new LootTable(new net.minecraft.world.storage.loot.LootPool[0]);
    private final net.minecraft.world.storage.loot.LootPool[] pools;

    public LootTable(net.minecraft.world.storage.loot.LootPool[] poolsIn)
    {
        this.pools = poolsIn;
    }
    ...
    public List<ItemStack> generateLootForPools(Random rand, LootContext context)
    {
        ...
        {
            for (net.minecraft.world.storage.loot.LootPool lootpool : this.pools)
            {
    ...
    public static class Serializer implements JsonDeserializer<LootTable>, JsonSerializer<LootTable>
    {
        public LootTable deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException
        {
            ...
            net.minecraft.world.storage.loot.LootPool[] alootpool = (net.minecraft.world.storage.loot.LootPool[])JsonUtils.deserializeClass(jsonobject, "pools", new net.minecraft.world.storage.loot.LootPool[0], p_deserialize_3_, LootPool[].class);
