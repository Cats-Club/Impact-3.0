...
public class StructureMineshaftPieces
{
    ...
    {
        net.minecraft.world.gen.structure.MapGenStructureIO.registerStructureComponent(Corridor.class, "MSCorridor");
        net.minecraft.world.gen.structure.MapGenStructureIO.registerStructureComponent(Cross.class, "MSCrossing");
        net.minecraft.world.gen.structure.MapGenStructureIO.registerStructureComponent(Room.class, "MSRoom");
        MapGenStructureIO.registerStructureComponent(Stairs.class, "MSStairs");
    }

    private static Peice func_189940_a(List<net.minecraft.world.gen.structure.StructureComponent> p_189940_0_, Random p_189940_1_, int p_189940_2_, int p_189940_3_, int p_189940_4_, @Nullable EnumFacing p_189940_5_, int p_189940_6_, net.minecraft.world.gen.structure.MapGenMineshaft.Type p_189940_7_)
    {
        int i = p_189940_1_.nextInt(100);

        if (i >= 80)
        {
            net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox = Cross.findCrossing(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
        ...
        {
            net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox1 = Stairs.findStairs(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
        ...
        {
            net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox2 = Corridor.findCorridorSize(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
    ...
    private static Peice func_189938_b(net.minecraft.world.gen.structure.StructureComponent p_189938_0_, List<net.minecraft.world.gen.structure.StructureComponent> p_189938_1_, Random p_189938_2_, int p_189938_3_, int p_189938_4_, int p_189938_5_, EnumFacing p_189938_6_, int p_189938_7_)
    {
        if (p_189938_7_ > 8)
        {
            return null;
        ...
        {
            net.minecraft.world.gen.structure.MapGenMineshaft.Type mapgenmineshaft$type = ((Peice)p_189938_0_).field_189920_a;
            Peice structuremineshaftpieces$peice = func_189940_a(p_189938_1_, p_189938_2_, p_189938_3_, p_189938_4_, p_189938_5_, p_189938_6_, p_189938_7_ + 1, mapgenmineshaft$type);
    ...
    public static class Corridor extends Peice
    {
        ...
        public Corridor(int p_i47140_1_, Random p_i47140_2_, net.minecraft.world.gen.structure.StructureBoundingBox p_i47140_3_, EnumFacing p_i47140_4_, net.minecraft.world.gen.structure.MapGenMineshaft.Type p_i47140_5_)
        {
        ...
        public static net.minecraft.world.gen.structure.StructureBoundingBox findCorridorSize(List<net.minecraft.world.gen.structure.StructureComponent> p_175814_0_, Random rand, int x, int y, int z, EnumFacing facing)
        {
            net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox = new net.minecraft.world.gen.structure.StructureBoundingBox(x, y, z, x, y + 2, z);
            int i;
            ...
            for (i = rand.nextInt(3) + 2; i > 0; --i)
            {
                ...
                if (net.minecraft.world.gen.structure.StructureComponent.findIntersecting(p_175814_0_, structureboundingbox) == null)
                {
                    break;
                }
            }
        ...
        public void buildComponent(net.minecraft.world.gen.structure.StructureComponent componentIn, List<net.minecraft.world.gen.structure.StructureComponent> listIn, Random rand)
        {
        ...
        protected boolean generateChest(World worldIn, net.minecraft.world.gen.structure.StructureBoundingBox structurebb, Random randomIn, int x, int y, int z, ResourceLocation loot)
        {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, net.minecraft.world.gen.structure.StructureBoundingBox structureBoundingBoxIn)
        {
        ...
        private void func_189921_a(World p_189921_1_, net.minecraft.world.gen.structure.StructureBoundingBox p_189921_2_, int p_189921_3_, int p_189921_4_, int p_189921_5_, int p_189921_6_, int p_189921_7_, Random p_189921_8_)
        {
        ...
        private void func_189922_a(World p_189922_1_, net.minecraft.world.gen.structure.StructureBoundingBox p_189922_2_, Random p_189922_3_, float p_189922_4_, int p_189922_5_, int p_189922_6_, int p_189922_7_)
        {
    ...
    public static class Cross extends Peice
    {
        ...
        public Cross(int p_i47139_1_, Random p_i47139_2_, net.minecraft.world.gen.structure.StructureBoundingBox p_i47139_3_, @Nullable EnumFacing p_i47139_4_, net.minecraft.world.gen.structure.MapGenMineshaft.Type p_i47139_5_)
        {
        ...
        public static net.minecraft.world.gen.structure.StructureBoundingBox findCrossing(List<net.minecraft.world.gen.structure.StructureComponent> listIn, Random rand, int x, int y, int z, EnumFacing facing)
        {
            net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox = new net.minecraft.world.gen.structure.StructureBoundingBox(x, y, z, x, y + 2, z);
            ...
            return net.minecraft.world.gen.structure.StructureComponent.findIntersecting(listIn, structureboundingbox) != null ? null : structureboundingbox;
        }
        ...
        private void func_189923_b(World p_189923_1_, net.minecraft.world.gen.structure.StructureBoundingBox p_189923_2_, int p_189923_3_, int p_189923_4_, int p_189923_5_, int p_189923_6_)
        {
    ...
    abstract static class Peice extends net.minecraft.world.gen.structure.StructureComponent
    {
        protected net.minecraft.world.gen.structure.MapGenMineshaft.Type field_189920_a;

        public Peice()
        {
        }

        public Peice(int p_i47138_1_, net.minecraft.world.gen.structure.MapGenMineshaft.Type p_i47138_2_)
        {
            super(p_i47138_1_);
        ...
        protected void readStructureFromNBT(NBTTagCompound tagCompound)
        {
            this.field_189920_a = net.minecraft.world.gen.structure.MapGenMineshaft.Type.func_189910_a(tagCompound.getInteger("MST"));
        }
        ...
        protected boolean func_189918_a(World p_189918_1_, net.minecraft.world.gen.structure.StructureBoundingBox p_189918_2_, int p_189918_3_, int p_189918_4_, int p_189918_5_, int p_189918_6_)
        {
    ...
    {
        private final List<net.minecraft.world.gen.structure.StructureBoundingBox> roomsLinkedToTheRoom = Lists.<net.minecraft.world.gen.structure.StructureBoundingBox>newLinkedList();

        public Room()
        {
        }

        public Room(int p_i47137_1_, Random p_i47137_2_, int p_i47137_3_, int p_i47137_4_, net.minecraft.world.gen.structure.MapGenMineshaft.Type p_i47137_5_)
        {
            super(p_i47137_1_, p_i47137_5_);
            this.field_189920_a = p_i47137_5_;
            this.boundingBox = new net.minecraft.world.gen.structure.StructureBoundingBox(p_i47137_3_, 50, p_i47137_4_, p_i47137_3_ + 7 + p_i47137_2_.nextInt(6), 54 + p_i47137_2_.nextInt(6), p_i47137_4_ + 7 + p_i47137_2_.nextInt(6));
        }
        ...
        public void buildComponent(net.minecraft.world.gen.structure.StructureComponent componentIn, List<net.minecraft.world.gen.structure.StructureComponent> listIn, Random rand)
        {
            ...
            for (int j = 0; j < this.boundingBox.getXSize(); j = l + 4)
            {
                ...
                Peice structuremineshaftpieces$peice = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + l, this.boundingBox.minY + rand.nextInt(k) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);

                if (structuremineshaftpieces$peice != null)
                {
                    net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox = structuremineshaftpieces$peice.getBoundingBox();
                    this.roomsLinkedToTheRoom.add(new net.minecraft.world.gen.structure.StructureBoundingBox(structureboundingbox.minX, structureboundingbox.minY, this.boundingBox.minZ, structureboundingbox.maxX, structureboundingbox.maxY, this.boundingBox.minZ + 1));
                }
            }
            ...
            for (int i1 = 0; i1 < this.boundingBox.getXSize(); i1 = l + 4)
            {
                ...
                Peice structuremineshaftpieces$peice1 = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + l, this.boundingBox.minY + rand.nextInt(k) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);

                if (structuremineshaftpieces$peice1 != null)
                {
                    net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox1 = structuremineshaftpieces$peice1.getBoundingBox();
                    this.roomsLinkedToTheRoom.add(new net.minecraft.world.gen.structure.StructureBoundingBox(structureboundingbox1.minX, structureboundingbox1.minY, this.boundingBox.maxZ - 1, structureboundingbox1.maxX, structureboundingbox1.maxY, this.boundingBox.maxZ));
                }
            }
            ...
            for (int j1 = 0; j1 < this.boundingBox.getZSize(); j1 = l + 4)
            {
                ...
                Peice structuremineshaftpieces$peice2 = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(k) + 1, this.boundingBox.minZ + l, EnumFacing.WEST, i);

                if (structuremineshaftpieces$peice2 != null)
                {
                    net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox2 = structuremineshaftpieces$peice2.getBoundingBox();
                    this.roomsLinkedToTheRoom.add(new net.minecraft.world.gen.structure.StructureBoundingBox(this.boundingBox.minX, structureboundingbox2.minY, structureboundingbox2.minZ, this.boundingBox.minX + 1, structureboundingbox2.maxY, structureboundingbox2.maxZ));
                }
            }
            ...
            for (int k1 = 0; k1 < this.boundingBox.getZSize(); k1 = l + 4)
            {
                ...
                net.minecraft.world.gen.structure.StructureComponent structurecomponent = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(k) + 1, this.boundingBox.minZ + l, EnumFacing.EAST, i);

                if (structurecomponent != null)
                {
                    net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox3 = structurecomponent.getBoundingBox();
                    this.roomsLinkedToTheRoom.add(new net.minecraft.world.gen.structure.StructureBoundingBox(this.boundingBox.maxX - 1, structureboundingbox3.minY, structureboundingbox3.minZ, this.boundingBox.maxX, structureboundingbox3.maxY, structureboundingbox3.maxZ));
                }
            }
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, net.minecraft.world.gen.structure.StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            else
            {
                ...
                for (net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox : this.roomsLinkedToTheRoom)
                {
        ...
        protected void readStructureFromNBT(NBTTagCompound tagCompound)
        {
            ...
            {
                this.roomsLinkedToTheRoom.add(new net.minecraft.world.gen.structure.StructureBoundingBox(nbttaglist.getIntArrayAt(i)));
            }
        }
    }
    ...
    public static class Stairs extends Peice
    {
        ...
        public Stairs(int p_i47136_1_, Random p_i47136_2_, net.minecraft.world.gen.structure.StructureBoundingBox p_i47136_3_, EnumFacing p_i47136_4_, MapGenMineshaft.Type p_i47136_5_)
        {
        ...
        public static net.minecraft.world.gen.structure.StructureBoundingBox findStairs(List<net.minecraft.world.gen.structure.StructureComponent> listIn, Random rand, int x, int y, int z, EnumFacing facing)
        {
            net.minecraft.world.gen.structure.StructureBoundingBox structureboundingbox = new net.minecraft.world.gen.structure.StructureBoundingBox(x, y - 5, z, x, y + 2, z);
        ...
        public void buildComponent(net.minecraft.world.gen.structure.StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            int i = this.getComponentType();
            EnumFacing enumfacing = this.getCoordBaseMode();
