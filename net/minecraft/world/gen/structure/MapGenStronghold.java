...
public class MapGenStronghold extends MapGenStructure
{
    ...
    private void generatePositions()
    {
        ...
        for (net.minecraft.world.gen.structure.StructureStart structurestart : this.structureMap.values())
        {
    ...
    protected net.minecraft.world.gen.structure.StructureStart getStructureStart(int chunkX, int chunkZ)
    {
