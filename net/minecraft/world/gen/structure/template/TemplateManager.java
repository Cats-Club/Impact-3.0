...
{
    private final Map<String, net.minecraft.world.gen.structure.template.Template> templates = Maps.<String, net.minecraft.world.gen.structure.template.Template>newHashMap();
    ...
    public net.minecraft.world.gen.structure.template.Template getTemplate(@Nullable MinecraftServer server, ResourceLocation id)
    {
        net.minecraft.world.gen.structure.template.Template template = this.func_189942_b(server, id);

        if (template == null)
        {
            template = new net.minecraft.world.gen.structure.template.Template();
    ...
    @Nullable
    public net.minecraft.world.gen.structure.template.Template func_189942_b(@Nullable MinecraftServer p_189942_1_, ResourceLocation p_189942_2_)
    {
        String s = p_189942_2_.getResourcePath();

        if (this.templates.containsKey(s))
        {
            return (net.minecraft.world.gen.structure.template.Template)this.templates.get(s);
        }
        else
        {
            if (p_189942_1_ != null)
            ...
            return this.templates.containsKey(s) ? (net.minecraft.world.gen.structure.template.Template)this.templates.get(s) : null;
        }
    }
    ...
    private void readTemplateFromStream(String id, InputStream stream) throws IOException
    {
        ...
        net.minecraft.world.gen.structure.template.Template template = new net.minecraft.world.gen.structure.template.Template();
    ...
    public boolean writeTemplate(@Nullable MinecraftServer server, ResourceLocation id)
    {
        ...
        if (server != null && this.templates.containsKey(s))
        {
            ...
            net.minecraft.world.gen.structure.template.Template template = (Template)this.templates.get(s);
