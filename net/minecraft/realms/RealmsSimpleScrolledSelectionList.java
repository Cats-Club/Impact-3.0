...
public class RealmsSimpleScrolledSelectionList
{
    ...
    protected void renderItem(int p_renderItem_1_, int p_renderItem_2_, int p_renderItem_3_, int p_renderItem_4_, net.minecraft.realms.Tezzelator p_renderItem_5_, int p_renderItem_6_, int p_renderItem_7_)
    {
    }
