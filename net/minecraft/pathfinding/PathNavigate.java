...
public abstract class PathNavigate
{
    ...
    protected net.minecraft.pathfinding.Path currentPath;
    ...
    private final net.minecraft.pathfinding.PathFinder pathFinder;
     ...
     */
    public final net.minecraft.pathfinding.Path getPathToXYZ(double x, double y, double z)
    {
     ...
     */
    public net.minecraft.pathfinding.Path getPathToPos(BlockPos pos)
    {
        if (!this.canNavigate())
        {
            return null;
        ...
        else
        {
            ...
            net.minecraft.pathfinding.Path path = this.pathFinder.findPath(chunkcache, this.theEntity, this.targetPos, f);
     ...
     */
    public net.minecraft.pathfinding.Path getPathToEntityLiving(Entity entityIn)
    {
        if (!this.canNavigate())
        {
            return null;
        ...
        else
        {
            ...
            else
            {
                ...
                net.minecraft.pathfinding.Path path = this.pathFinder.findPath(chunkcache, this.theEntity, entityIn, f);
                this.worldObj.theProfiler.endSection();
                return path;
            }
        }
    ...
    {
        net.minecraft.pathfinding.Path path = this.getPathToEntityLiving(entityIn);
     ...
     */
    public boolean setPath(@Nullable net.minecraft.pathfinding.Path pathentityIn, double speedIn)
    {
