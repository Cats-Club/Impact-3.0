...
public class ItemEnderEye extends Item
{
     ...
     */
    public EnumActionResult onItemUse(net.minecraft.item.ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
