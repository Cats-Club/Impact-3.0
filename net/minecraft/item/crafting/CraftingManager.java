...
public class CraftingManager
{
    ...
    private final List<net.minecraft.item.crafting.IRecipe> recipes = Lists.<net.minecraft.item.crafting.IRecipe>newArrayList();
    ...
    private CraftingManager()
    {
        ...
        Collections.sort(this.recipes, new Comparator<net.minecraft.item.crafting.IRecipe>()
        {
            public int compare(net.minecraft.item.crafting.IRecipe p_compare_1_, net.minecraft.item.crafting.IRecipe p_compare_2_)
            {
                return p_compare_1_ instanceof ShapelessRecipes && p_compare_2_ instanceof net.minecraft.item.crafting.ShapedRecipes ? 1 : (p_compare_2_ instanceof ShapelessRecipes && p_compare_1_ instanceof net.minecraft.item.crafting.ShapedRecipes ? -1 : (p_compare_2_.getRecipeSize() < p_compare_1_.getRecipeSize() ? -1 : (p_compare_2_.getRecipeSize() > p_compare_1_.getRecipeSize() ? 1 : 0)));
            }
        });
    }
     ...
     */
    public net.minecraft.item.crafting.ShapedRecipes addRecipe(ItemStack stack, Object... recipeComponents)
    {
        String s = "";
        int i = 0;
        int j = 0;
        ...
        net.minecraft.item.crafting.ShapedRecipes shapedrecipes = new ShapedRecipes(j, k, aitemstack, stack);
     ...
     */
    public void addRecipe(net.minecraft.item.crafting.IRecipe recipe)
    {
    ...
    {
        for (net.minecraft.item.crafting.IRecipe irecipe : this.recipes)
        {
