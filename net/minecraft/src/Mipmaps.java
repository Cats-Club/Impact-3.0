...
public class Mipmaps
{
    ...
    public Mipmaps(String p_i55_1_, int p_i55_2_, int p_i55_3_, int[] p_i55_4_, boolean p_i55_5_)
    {
        this.iconName = p_i55_1_;
        this.width = p_i55_2_;
        this.height = p_i55_3_;
        this.data = p_i55_4_;
        this.direct = p_i55_5_;
        this.mipmapDimensions = makeMipmapDimensions(p_i55_2_, p_i55_3_, p_i55_1_);
        this.mipmapDatas = generateMipMapData(p_i55_4_, p_i55_2_, p_i55_3_, this.mipmapDimensions);
