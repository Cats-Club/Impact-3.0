...
public class NaturalProperties
{
    ...
    public NaturalProperties(String p_i57_1_)
    {
        if (p_i57_1_.equals("4"))
        {
            this.rotation = 4;
        }
        else if (p_i57_1_.equals("2"))
        {
            this.rotation = 2;
        }
        else if (p_i57_1_.equals("F"))
        {
            this.flip = true;
        }
        else if (p_i57_1_.equals("4F"))
        {
            this.rotation = 4;
            this.flip = true;
        }
        else if (p_i57_1_.equals("2F"))
        {
            this.rotation = 2;
            this.flip = true;
        }
        ...
        {
            Config.warn("NaturalTextures: Unknown type: " + p_i57_1_);
        }
    }
