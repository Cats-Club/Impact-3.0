...
public class RandomMobsProperties
{
    ...
    public RandomMobsProperties(String p_i66_1_, ResourceLocation[] p_i66_2_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i66_1_);
        this.basePath = connectedparser.parseBasePath(p_i66_1_);
        this.resourceLocations = p_i66_2_;
    }

    public RandomMobsProperties(Properties p_i67_1_, String p_i67_2_, ResourceLocation p_i67_3_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i67_2_);
        this.basePath = connectedparser.parseBasePath(p_i67_2_);
        this.rules = this.parseRules(p_i67_1_, p_i67_3_, connectedparser);
    }
