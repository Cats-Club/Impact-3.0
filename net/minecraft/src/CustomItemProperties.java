...
public class CustomItemProperties
{
    ...
    public CustomItemProperties(Properties p_i29_1_, String p_i29_2_)
    {
        this.name = parseName(p_i29_2_);
        this.basePath = parseBasePath(p_i29_2_);
        this.type = this.parseType(p_i29_1_.getProperty("type"));
        this.items = this.parseItems(p_i29_1_.getProperty("items"), p_i29_1_.getProperty("matchItems"));
        this.mapTextures = parseTextures(p_i29_1_, this.basePath);
        this.texture = parseTexture(p_i29_1_.getProperty("texture"), p_i29_1_.getProperty("tile"), p_i29_1_.getProperty("source"), p_i29_2_, this.basePath, this.type, this.mapTextures);
        String s = p_i29_1_.getProperty("damage");
        ...
        if (s != null)
        {
            ...
            this.damageMask = this.parseInt(p_i29_1_.getProperty("damageMask"), 0);
        }

        this.stackSize = this.parseRangeListInt(p_i29_1_.getProperty("stackSize"));
        this.enchantmentIds = this.parseRangeListInt(p_i29_1_.getProperty("enchantmentIDs"));
        this.enchantmentLevels = this.parseRangeListInt(p_i29_1_.getProperty("enchantmentLevels"));
        this.nbtTagValues = this.parseNbtTagValues(p_i29_1_);
        this.blend = Blender.parseBlend(p_i29_1_.getProperty("blend"));
        this.speed = this.parseFloat(p_i29_1_.getProperty("speed"), 0.0F);
        this.rotation = this.parseFloat(p_i29_1_.getProperty("rotation"), 0.0F);
        this.layer = this.parseInt(p_i29_1_.getProperty("layer"), 0);
        this.weight = this.parseInt(p_i29_1_.getProperty("weight"), 0);
        this.duration = this.parseFloat(p_i29_1_.getProperty("duration"), 1.0F);
    }
