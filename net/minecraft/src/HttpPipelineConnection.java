...
public class HttpPipelineConnection
{
    ...
    public HttpPipelineConnection(String p_i44_1_, int p_i44_2_)
    {
        this(p_i44_1_, p_i44_2_, Proxy.NO_PROXY);
    }

    public HttpPipelineConnection(String p_i45_1_, int p_i45_2_, Proxy p_i45_3_)
    {
        this.host = null;
        this.port = 0;
