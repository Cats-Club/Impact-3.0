...
public class NbtTagValue
{
    ...
    public NbtTagValue(String p_i58_1_, String p_i58_2_)
    {
        String[] astring = Config.tokenize(p_i58_1_, ".");
        this.parents = (String[])Arrays.copyOfRange(astring, 0, astring.length - 1);
        this.name = astring[astring.length - 1];

        if (p_i58_2_.startsWith("pattern:"))
        {
            this.type = 1;
            p_i58_2_ = p_i58_2_.substring("pattern:".length());
        }
        else if (p_i58_2_.startsWith("ipattern:"))
        {
            this.type = 2;
            p_i58_2_ = p_i58_2_.substring("ipattern:".length()).toLowerCase();
        }
        else if (p_i58_2_.startsWith("regex:"))
        {
            this.type = 3;
            p_i58_2_ = p_i58_2_.substring("regex:".length());
        }
        else if (p_i58_2_.startsWith("iregex:"))
        {
            this.type = 4;
            p_i58_2_ = p_i58_2_.substring("iregex:".length()).toLowerCase();
        }
        else
        {
            this.type = 0;
        ...
        p_i58_2_ = StringEscapeUtils.unescapeJava(p_i58_2_);
        this.value = p_i58_2_;
    }
