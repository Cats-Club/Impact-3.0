...
public class CompactArrayList
{
    ...
    public CompactArrayList(int p_i23_1_)
    {
        this(p_i23_1_, 0.75F);
    }

    public CompactArrayList(int p_i24_1_, float p_i24_2_)
    {
        this.list = null;
        this.initialCapacity = 0;
        this.loadFactor = 1.0F;
        this.countValid = 0;
        this.list = new ArrayList(p_i24_1_);
        this.initialCapacity = p_i24_1_;
        this.loadFactor = p_i24_2_;
    }
