...
public class CustomColormap implements CustomColors.IColorizer
{
    ...
    public CustomColormap(Properties p_i28_1_, String p_i28_2_, int p_i28_3_, int p_i28_4_)
    {
        ConnectedParser connectedparser = new ConnectedParser("Colormap");
        this.name = connectedparser.parseName(p_i28_2_);
        this.basePath = connectedparser.parseBasePath(p_i28_2_);
        this.format = this.parseFormat(p_i28_1_.getProperty("format"));
        this.matchBlocks = connectedparser.parseMatchBlocks(p_i28_1_.getProperty("blocks"));
        this.source = parseTexture(p_i28_1_.getProperty("source"), p_i28_2_, this.basePath);
        this.color = ConnectedParser.parseColor(p_i28_1_.getProperty("color"), -1);
        this.yVariance = connectedparser.parseInt(p_i28_1_.getProperty("yVariance"), 0);
        this.yOffset = connectedparser.parseInt(p_i28_1_.getProperty("yOffset"), 0);
        this.width = p_i28_3_;
        this.height = p_i28_4_;
    }
