...
public class ConnectedProperties
{
    ...
    public ConnectedProperties(Properties p_i26_1_, String p_i26_2_)
    {
        ConnectedParser connectedparser = new ConnectedParser("ConnectedTextures");
        this.name = connectedparser.parseName(p_i26_2_);
        this.basePath = connectedparser.parseBasePath(p_i26_2_);
        this.matchBlocks = connectedparser.parseMatchBlocks(p_i26_1_.getProperty("matchBlocks"));
        this.metadatas = connectedparser.parseIntList(p_i26_1_.getProperty("metadata"));
        this.matchTiles = this.parseMatchTiles(p_i26_1_.getProperty("matchTiles"));
        this.method = parseMethod(p_i26_1_.getProperty("method"));
        this.tiles = this.parseTileNames(p_i26_1_.getProperty("tiles"));
        this.connect = parseConnect(p_i26_1_.getProperty("connect"));
        this.faces = parseFaces(p_i26_1_.getProperty("faces"));
        this.biomes = connectedparser.parseBiomes(p_i26_1_.getProperty("biomes"));
        this.minHeight = connectedparser.parseInt(p_i26_1_.getProperty("minHeight"), -1);
        this.maxHeight = connectedparser.parseInt(p_i26_1_.getProperty("maxHeight"), 1024);
        this.renderPass = connectedparser.parseInt(p_i26_1_.getProperty("renderPass"));
        this.innerSeams = ConnectedParser.parseBoolean(p_i26_1_.getProperty("innerSeams"));
        this.ctmTileIndexes = this.parseCtmTileIndexes(p_i26_1_);
        this.width = connectedparser.parseInt(p_i26_1_.getProperty("width"));
        this.height = connectedparser.parseInt(p_i26_1_.getProperty("height"));
        this.weights = connectedparser.parseIntList(p_i26_1_.getProperty("weights"));
        this.symmetry = parseSymmetry(p_i26_1_.getProperty("symmetry"));
        this.connectBlocks = connectedparser.parseMatchBlocks(p_i26_1_.getProperty("connectBlocks"));
        this.connectTiles = this.parseMatchTiles(p_i26_1_.getProperty("connectTiles"));
        this.tintIndex = connectedparser.parseInt(p_i26_1_.getProperty("tintIndex"));
        this.tintBlockState = connectedparser.parseBlockState(p_i26_1_.getProperty("tintBlock"), Blocks.AIR.getDefaultState());
        this.layer = connectedparser.parseBlockRenderLayer(p_i26_1_.getProperty("layer"), BlockRenderLayer.CUTOUT_MIPPED);
    }
