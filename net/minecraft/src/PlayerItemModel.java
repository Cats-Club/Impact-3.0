...
public class PlayerItemModel
{
    ...
    public PlayerItemModel(Dimension p_i62_1_, boolean p_i62_2_, PlayerItemRenderer[] p_i62_3_)
    {
        this.textureSize = p_i62_1_;
        this.usePlayerTexture = p_i62_2_;
        this.modelRenderers = p_i62_3_;
    }
