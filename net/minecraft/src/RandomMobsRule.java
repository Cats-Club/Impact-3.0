...
public class RandomMobsRule
{
    ...
    public RandomMobsRule(ResourceLocation p_i68_1_, int[] p_i68_2_, int[] p_i68_3_, Biome[] p_i68_4_, RangeListInt p_i68_5_)
    {
        this.baseResLoc = p_i68_1_;
        this.skins = p_i68_2_;
        this.weights = p_i68_3_;
        this.biomes = p_i68_4_;
        this.heights = p_i68_5_;
    }
