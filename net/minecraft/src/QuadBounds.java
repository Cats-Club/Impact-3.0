...
public class QuadBounds
{
    ...
    public QuadBounds(int[] p_i65_1_)
    {
        int i = p_i65_1_.length / 4;

        for (int j = 0; j < 4; ++j)
        {
            int k = j * i;
            float f = Float.intBitsToFloat(p_i65_1_[k + 0]);
            float f1 = Float.intBitsToFloat(p_i65_1_[k + 1]);
            float f2 = Float.intBitsToFloat(p_i65_1_[k + 2]);
