...
public class CustomPanoramaProperties
{
    ...
    public CustomPanoramaProperties(String p_i30_1_, Properties p_i30_2_)
    {
        ...
        {
            this.panoramaLocations[i] = new ResourceLocation(p_i30_1_ + "/panorama_" + i + ".png");
        }

        this.weight = connectedparser.parseInt(p_i30_2_.getProperty("weight"), 1);
        this.blur1 = connectedparser.parseInt(p_i30_2_.getProperty("blur1"), 64);
        this.blur2 = connectedparser.parseInt(p_i30_2_.getProperty("blur2"), 3);
        this.blur3 = connectedparser.parseInt(p_i30_2_.getProperty("blur3"), 3);
        this.overlay1Top = ConnectedParser.parseColor4(p_i30_2_.getProperty("overlay1.top"), -2130706433);
        this.overlay1Bottom = ConnectedParser.parseColor4(p_i30_2_.getProperty("overlay1.bottom"), 16777215);
        this.overlay2Top = ConnectedParser.parseColor4(p_i30_2_.getProperty("overlay2.top"), 0);
        this.overlay2Bottom = ConnectedParser.parseColor4(p_i30_2_.getProperty("overlay2.bottom"), Integer.MIN_VALUE);
    }
