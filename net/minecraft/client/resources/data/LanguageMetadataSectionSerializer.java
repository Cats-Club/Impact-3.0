...
public class LanguageMetadataSectionSerializer extends BaseMetadataSectionSerializer<net.minecraft.client.resources.data.LanguageMetadataSection>
{
    public net.minecraft.client.resources.data.LanguageMetadataSection deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException
    {
