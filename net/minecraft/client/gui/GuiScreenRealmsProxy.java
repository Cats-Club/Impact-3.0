...
public class GuiScreenRealmsProxy extends GuiScreen
{
    ...
    {
        this.proxy = proxyIn;
        super.buttonList = Collections.<net.minecraft.client.gui.GuiButton>synchronizedList(Lists.<net.minecraft.client.gui.GuiButton>newArrayList());
    }
     ...
     */
    public final void actionPerformed(net.minecraft.client.gui.GuiButton button) throws IOException
    {
        this.proxy.buttonClicked(((net.minecraft.client.gui.GuiButtonRealmsProxy)button).getRealmsButton());
    }
