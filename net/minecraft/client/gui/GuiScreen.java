...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public int height;
    protected List<net.minecraft.client.gui.GuiButton> buttonList = Lists.<net.minecraft.client.gui.GuiButton>newArrayList();
    protected List<net.minecraft.client.gui.GuiLabel> labelList = Lists.<net.minecraft.client.gui.GuiLabel>newArrayList();
    ...
    private net.minecraft.client.gui.GuiButton selectedButton;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            ((net.minecraft.client.gui.GuiButton)this.buttonList.get(i)).drawButton(this.mc, mouseX, mouseY);
        }
    ...
    protected <T extends net.minecraft.client.gui.GuiButton> T func_189646_b(T p_189646_1_)
    {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
            for (int i = 0; i < this.buttonList.size(); ++i)
            {
                net.minecraft.client.gui.GuiButton guibutton = (net.minecraft.client.gui.GuiButton)this.buttonList.get(i);
