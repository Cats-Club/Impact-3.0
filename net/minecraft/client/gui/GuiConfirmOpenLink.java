...
public class GuiConfirmOpenLink extends GuiYesNo
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new net.minecraft.client.gui.GuiButton(0, this.width / 2 - 50 - 105, this.height / 6 + 96, 100, 20, this.confirmButtonText));
        this.buttonList.add(new net.minecraft.client.gui.GuiButton(2, this.width / 2 - 50, this.height / 6 + 96, 100, 20, this.copyLinkButtonText));
        this.buttonList.add(new net.minecraft.client.gui.GuiButton(1, this.width / 2 - 50 + 105, this.height / 6 + 96, 100, 20, this.cancelButtonText));
    }
