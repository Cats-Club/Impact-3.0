...
public class GuiCustomizeSkin extends net.minecraft.client.gui.GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new net.minecraft.client.gui.GuiButton(200, this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), I18n.format("gui.done", new Object[0])));
    }
