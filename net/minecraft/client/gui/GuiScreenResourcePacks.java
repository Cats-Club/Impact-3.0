...
public class GuiScreenResourcePacks extends net.minecraft.client.gui.GuiScreen
{
    ...
    public void initGui()
    {
        this.buttonList.add(new net.minecraft.client.gui.GuiOptionButton(2, this.width / 2 - 154, this.height - 48, I18n.format("resourcePack.openFolder", new Object[0])));
