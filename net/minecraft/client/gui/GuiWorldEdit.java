...
public class GuiWorldEdit extends net.minecraft.client.gui.GuiScreen
{
    private final net.minecraft.client.gui.GuiScreen lastScreen;
    private net.minecraft.client.gui.GuiTextField nameEdit;
    ...
    public void initGui()
    {
        ...
        net.minecraft.client.gui.GuiButton guibutton = this.func_189646_b(new net.minecraft.client.gui.GuiButton(3, this.width / 2 - 100, this.height / 4 + 24 + 12, I18n.format("selectWorld.edit.resetIcon", new Object[0])));
        this.buttonList.add(new net.minecraft.client.gui.GuiButton(4, this.width / 2 - 100, this.height / 4 + 48 + 12, I18n.format("selectWorld.edit.openFolder", new Object[0])));
        this.buttonList.add(new net.minecraft.client.gui.GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + 12, I18n.format("selectWorld.edit.save", new Object[0])));
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        ((net.minecraft.client.gui.GuiButton)this.buttonList.get(2)).enabled = !this.nameEdit.getText().trim().isEmpty();
