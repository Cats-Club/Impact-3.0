...
public class ShaderManager
{
    ...
    private static final net.minecraft.client.shader.ShaderDefault DEFAULT_SHADER_UNIFORM = new ShaderDefault();
    ...
    private final net.minecraft.client.shader.ShaderLoader vertexShaderLoader;
    private final net.minecraft.client.shader.ShaderLoader fragmentShaderLoader;
    ...
    public ShaderManager(IResourceManager resourceManager, String programName) throws JsonException, IOException
    {
        ...
        try
        {
            ...
            this.vertexShaderLoader = net.minecraft.client.shader.ShaderLoader.loadShader(resourceManager, net.minecraft.client.shader.ShaderLoader.ShaderType.VERTEX, s);
            this.fragmentShaderLoader = net.minecraft.client.shader.ShaderLoader.loadShader(resourceManager, net.minecraft.client.shader.ShaderLoader.ShaderType.FRAGMENT, s1);
    ...
    public void useShader()
    {
        ...
        for (int i = 0; i < this.shaderSamplerLocations.size(); ++i)
        {
            if (this.shaderSamplers.get(this.samplerNames.get(i)) != null)
            {
                ...
                if (object instanceof net.minecraft.client.shader.Framebuffer)
                {
    ...
    public net.minecraft.client.shader.ShaderLoader getVertexShaderLoader()
    {
