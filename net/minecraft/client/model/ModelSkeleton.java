...
public class ModelSkeleton extends net.minecraft.client.model.ModelBiped
{
    ...
    public ModelSkeleton(float modelSize, boolean p_i46303_2_)
    {
        ...
        if (!p_i46303_2_)
        {
            this.bipedRightArm = new net.minecraft.client.model.ModelRenderer(this, 40, 16);
            this.bipedRightArm.addBox(-1.0F, -2.0F, -1.0F, 2, 12, 2, modelSize);
            this.bipedRightArm.setRotationPoint(-5.0F, 2.0F, 0.0F);
            this.bipedLeftArm = new net.minecraft.client.model.ModelRenderer(this, 40, 16);
            this.bipedLeftArm.mirror = true;
            this.bipedLeftArm.addBox(-1.0F, -2.0F, -1.0F, 2, 12, 2, modelSize);
            this.bipedLeftArm.setRotationPoint(5.0F, 2.0F, 0.0F);
            this.bipedRightLeg = new net.minecraft.client.model.ModelRenderer(this, 0, 16);
            this.bipedRightLeg.addBox(-1.0F, 0.0F, -1.0F, 2, 12, 2, modelSize);
            this.bipedRightLeg.setRotationPoint(-2.0F, 12.0F, 0.0F);
            this.bipedLeftLeg = new net.minecraft.client.model.ModelRenderer(this, 0, 16);
