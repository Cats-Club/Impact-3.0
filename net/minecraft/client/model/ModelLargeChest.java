...
public class ModelLargeChest extends ModelChest
{
    ...
    {
        this.chestLid = (new net.minecraft.client.model.ModelRenderer(this, 0, 0)).setTextureSize(128, 64);
        this.chestLid.addBox(0.0F, -5.0F, -14.0F, 30, 5, 14, 0.0F);
        this.chestLid.rotationPointX = 1.0F;
        this.chestLid.rotationPointY = 7.0F;
        this.chestLid.rotationPointZ = 15.0F;
        this.chestKnob = (new net.minecraft.client.model.ModelRenderer(this, 0, 0)).setTextureSize(128, 64);
