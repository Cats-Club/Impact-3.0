...
public class ModelEnderMite extends ModelBase
{
    ...
    private final net.minecraft.client.model.ModelRenderer[] bodyParts;

    public ModelEnderMite()
    {
        this.bodyParts = new net.minecraft.client.model.ModelRenderer[BODY_COUNT];
        float f = -3.5F;

        for (int i = 0; i < this.bodyParts.length; ++i)
        {
            this.bodyParts[i] = new net.minecraft.client.model.ModelRenderer(this, BODY_TEXS[i][0], BODY_TEXS[i][1]);
