...
{
    net.minecraft.client.model.ModelRenderer[] segments = new net.minecraft.client.model.ModelRenderer[8];
    net.minecraft.client.model.ModelRenderer core;
    ...
    public ModelMagmaCube()
    {
        for (int i = 0; i < this.segments.length; ++i)
        {
            ...
            this.segments[i] = new net.minecraft.client.model.ModelRenderer(this, j, k);
            this.segments[i].addBox(-4.0F, (float)(16 + i), -4.0F, 8, 1, 8);
        }

        this.core = new net.minecraft.client.model.ModelRenderer(this, 0, 16);
