...
{
    private final List<net.minecraft.client.renderer.block.model.multipart.Selector> selectors;
    private BlockStateContainer stateContainer;

    public Multipart(List<net.minecraft.client.renderer.block.model.multipart.Selector> selectorsIn)
    {
        this.selectors = selectorsIn;
    }

    public List<net.minecraft.client.renderer.block.model.multipart.Selector> getSelectors()
    {
    ...
    public Set<VariantList> getVariants()
    {
        ...
        for (net.minecraft.client.renderer.block.model.multipart.Selector selector : this.selectors)
        {
    ...
    public static class Deserializer implements JsonDeserializer<Multipart>
    {
        ...
        private List<net.minecraft.client.renderer.block.model.multipart.Selector> getSelectors(JsonDeserializationContext context, JsonArray elements)
        {
            List<net.minecraft.client.renderer.block.model.multipart.Selector> list = Lists.<net.minecraft.client.renderer.block.model.multipart.Selector>newArrayList();

            for (JsonElement jsonelement : elements)
            {
                list.add((net.minecraft.client.renderer.block.model.multipart.Selector)context.deserialize(jsonelement, Selector.class));
            }
