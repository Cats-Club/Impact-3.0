...
public class BlockModelRenderer
{
    ...
    private void renderQuadsFlat(IBlockAccess p_renderQuadsFlat_1_, IBlockState p_renderQuadsFlat_2_, BlockPos p_renderQuadsFlat_3_, int p_renderQuadsFlat_4_, boolean p_renderQuadsFlat_5_, VertexBuffer p_renderQuadsFlat_6_, List<BakedQuad> p_renderQuadsFlat_7_, RenderEnv p_renderQuadsFlat_8_)
    {
        ...
        for (int k1 = p_renderQuadsFlat_7_.size(); j1 < k1; ++j1)
        {
            BakedQuad bakedquad = (BakedQuad)p_renderQuadsFlat_7_.get(j1);
            ...
            if (p_renderQuadsFlat_5_)
            {
                ...
                p_renderQuadsFlat_4_ = bitset.get(0) ? p_renderQuadsFlat_2_.getPackedLightmapCoords(p_renderQuadsFlat_1_, p_renderQuadsFlat_3_.offset(bakedquad.getFace())) : p_renderQuadsFlat_2_.getPackedLightmapCoords(p_renderQuadsFlat_1_, p_renderQuadsFlat_3_);
            }
            ...
            else
            {
                ...
                {
                    i1 = this.blockColors.colorMultiplier(p_renderQuadsFlat_2_, p_renderQuadsFlat_1_, p_renderQuadsFlat_3_, bakedquad.getTintIndex());
                }
