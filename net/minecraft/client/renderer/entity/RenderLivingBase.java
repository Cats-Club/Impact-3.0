...
public abstract class RenderLivingBase<T extends EntityLivingBase> extends Render<T>
{
    ...
    {
        // TODON'T: Impact
        EventEntityRender eventPre = new EventEntityRender(EventType.PRE, this, entity, x, y, z);
        ...
        // TODON'T: Impact
        EventEntityRender eventPost = new EventEntityRender(EventType.POST, this, entity, x, y, z);
