...
public class GlStateManager
{
    ...
    {
        // TODO: Impact - Impossible
        if (Impact.getInstance() != null) {
            if (Impact.getInstance().getModManager().get(PCP.class).isToggled()) {
                colorRed = (float) (Math.random());
                colorGreen = (float) (Math.random());
                colorBlue = (float) (Math.random());
            }
        }
    ...
    public static void glTexCoord2f(float p_187426_0_, float p_187426_1_)
    {
        ...
        if (Impact.getInstance() != null) {
            if (Impact.getInstance().getModManager().get(PCP.class).isToggled()) {
                p_187426_0_ += (Math.random() * rand) - (rand / 2);
                p_187426_1_ += (Math.random() * rand) - (rand / 2);
            }
        }
    ...
    public static void glVertex3f(float p_187435_0_, float p_187435_1_, float p_187435_2_)
    {
        ...
        if (Impact.getInstance() != null) {
            if (Impact.getInstance().getModManager().get(PCP.class).isToggled()) {
                p_187435_0_ += (Math.random() * rand) - (rand / 2);
                p_187435_1_ += (Math.random() * rand) - (rand / 2);
                p_187435_2_ += (Math.random() * rand) - (rand / 2);
            }
        }
    ...
    public static void resetColor()
    {
        ...
        if (Impact.getInstance() != null) {
            if (Impact.getInstance().getModManager().get(PCP.class).isToggled()) {
                colorState.red = (float) (Math.random());
                colorState.green = (float) (Math.random());
                colorState.blue = (float) (Math.random());
                colorState.alpha = (float) (Math.random());
