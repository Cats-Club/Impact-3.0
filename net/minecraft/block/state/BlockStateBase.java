...
public abstract class BlockStateBase implements net.minecraft.block.state.IBlockState
{
    ...
    public ImmutableTable < IProperty<?>, Comparable<?>, net.minecraft.block.state.IBlockState> getPropertyValueTable()
    {
        return null;
    }
