...
public class BlockChorusPlant extends net.minecraft.block.Block
{
    ...
    {
        net.minecraft.block.Block block = worldIn.getBlockState(pos.down()).getBlock();
        net.minecraft.block.Block block1 = worldIn.getBlockState(pos.up()).getBlock();
        net.minecraft.block.Block block2 = worldIn.getBlockState(pos.north()).getBlock();
        net.minecraft.block.Block block3 = worldIn.getBlockState(pos.east()).getBlock();
        net.minecraft.block.Block block4 = worldIn.getBlockState(pos.south()).getBlock();
        net.minecraft.block.Block block5 = worldIn.getBlockState(pos.west()).getBlock();
    ...
    public boolean canSurviveAt(World wordIn, BlockPos pos)
    {
        ...
        for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
        {
            ...
            net.minecraft.block.Block block = wordIn.getBlockState(blockpos).getBlock();
            ...
            if (block == this)
            {
                ...
                net.minecraft.block.Block block1 = wordIn.getBlockState(blockpos.down()).getBlock();
        ...
        net.minecraft.block.Block block2 = wordIn.getBlockState(pos.down()).getBlock();
