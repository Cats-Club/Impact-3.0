...
{
    protected final Map<net.minecraft.stats.StatBase, TupleIntJsonSerializable> statsData = Maps.<net.minecraft.stats.StatBase, TupleIntJsonSerializable>newConcurrentMap();
    ...
    public void increaseStat(EntityPlayer player, net.minecraft.stats.StatBase stat, int amount)
    {
     ...
     */
    public void unlockAchievement(EntityPlayer playerIn, net.minecraft.stats.StatBase statIn, int p_150873_3_)
    {
     ...
     */
    public int readStat(net.minecraft.stats.StatBase stat)
    {
    ...
    public <T extends IJsonSerializable> T getProgress(net.minecraft.stats.StatBase p_150870_1_)
    {
